...
# Separate list for FEV datasets
declare -a fev_datasets=('uci_air' 'hospital' 'mdense' 'hierachi')
...
# Download CSVs for FEV evaluations as well
for dataset_name in "${fev_datasets[@]}"; do
    python scripts_download_csv.py --experiment_name=eval_${dataset_name}_200 --save_dir=${PROJECT_ROOT}/tsExperiments/results/saved_csv
done
